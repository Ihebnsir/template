...
const courseCatalog = {
  excel: { id: 'excel', title: 'Excel & automatisation', price: '120 DT', duration: '6 semaines', level: 'Débutant', center: 'Centre Excel Pro', rating: '4.8', city: 'Tunis', category: 'Technologie' },
  ia: { id: 'ia', title: 'IA générative pour débutants', price: '260 DT', duration: '8 semaines', level: 'Débutant', center: 'TechLab Tunis', rating: '4.9', city: 'Tunis', category: 'Technologie' },
  anglais: { id: 'anglais', title: 'Anglais professionnel', price: '180 DT', duration: '5 semaines', level: 'Intermédiaire', center: 'Lingua Center', rating: '4.7', city: 'Sfax', category: 'Langues' },
  design: { id: 'design', title: 'UI/UX Design Essentials', price: '220 DT', duration: '7 semaines', level: 'Intermédiaire', center: 'Studio Creatif', rating: '4.8', city: 'Sousse', category: 'Design' },
  'search-ia': { id: 'search-ia', title: 'IA générative pour équipes', price: '320 DT', duration: '10 semaines', level: 'Avancé', center: 'Nova Academy', rating: '4.9', city: 'Ariana', category: 'Technologie' },
  'search-ang': { id: 'search-ang', title: 'Anglais professionnel', price: '190 DT', duration: '6 semaines', level: 'Intermédiaire', center: 'Lingua Center', rating: '4.7', city: 'Sfax', category: 'Langues' },
  'search-design': { id: 'search-design', title: 'UI/UX Design Essentials', price: '230 DT', duration: '8 semaines', level: 'Intermédiaire', center: 'Studio Creatif', rating: '4.8', city: 'Sousse', category: 'Design' },
  'detail-ia': { id: 'detail-ia', title: 'IA générative pour débutants', price: '260 DT', duration: '8 semaines', level: 'Débutant', center: 'TechLab Tunis', rating: '4.9', city: 'Tunis', category: 'Technologie' }
};
...
function renderFavoritesPage() {
  ...
  container.innerHTML = favorites.map(item => {
    const course = getCourseById(item.id) || { ...item, price: '—', duration: '—', level: '—', center: '—', rating: '—', city: '—', category: '—' };
    return `
      <article class="card">
        ...
        <div class="chip-group">
          ...
          <span class="chip">📍 ${course.city}</span>
...
function renderComparatorPage() {
  ...
  table.querySelectorAll('tbody tr').forEach(row => {
    row.querySelectorAll('td[data-compare-value]').forEach((cell, index) => {
      ...
      const course = getCourseById(item.id) || { ...item, price: '—', duration: '—', level: '—', center: '—', rating: '—', city: '—' };
